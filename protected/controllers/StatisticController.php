...
class StatisticController extends Controller
{
	...
	public function accessRules()
	{
        return array(
            array('allow',  // allow all users to perform 'index' and 'view' actions
                'actions'=>array('index','view', 'create','update', 'admin','delete', 'marks'),
                'roles'=>array('Администратор', 'Методист', 'Преподаватель'),
            ),
	...
	public function actionMarks()
	{
		...
		{
			$this->render('marks', array('flag'=>true, 'groups'=>$groups));
		}
		$this->render('marks', array('groups'=> $groups));
	}
}
